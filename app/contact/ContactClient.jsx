...
export default function ContactClient() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer:
        "We serve all of Oregon, Washington, and California from our yard in Springfield, Oregon. Our hazmat and mold remediation team is ready to respond quickly and professionally. If you're unsure whether we service your location, just give us a call!",
    },
  ];
  ...
  return (
    <>
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-lg">
          Spill or hazmat emergency anywhere in Oregon, Washington, or California? Call{" "}
